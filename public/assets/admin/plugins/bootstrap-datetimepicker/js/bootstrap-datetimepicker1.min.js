...
(function($){
	...
	DateTimePicker.prototype={
		constructor:DateTimePicker,init:function(element,options){
			...
			if(!this.format){
				...
				if(!this.format)this.format="M/dd/yyyy"
			}
			this._compileFormat();
			if(this.component){
		...
		,place:function(){
			...
			this.widget.css({
				position:position,top:offset.top,left:offset.left,right:offset.right
			})
		}
			...
			if(!target.is(".disabled")){
					switch(target[0].nodeName.toLowerCase()){
						case"th":switch(target[0].className){
							...
							break;
							case"prev":case"next":var vd=this.viewDate;
		...
		,formatDate:function(d){ 
			return this.format.replace(formatReplacer,function(match){
				...
				if(match==="ms")len=1;
				property=dateFormatComponents[match].property;///console.log(match);console.log(property);
				//console.log(d);
				if(property==="Hours12"){
					rv=d.getUTCHours();
					if(rv===0)rv=12;
				...
				if(methodName==="getUTCMonth"){			
					if(match=='M'){						
						rv=dates.en.monthsShort[rv];
					}
					else if(match=='MM'){						
						rv=dates.en.months[rv];
					}
					else{
						rv=rv+1;
					}
		...
		,_compileFormat:function(){
			...
			while(match=formatComponent.exec(str)){
				...
				if(component in dateFormatComponents){
					...
					mask.push({
						pattern:new RegExp(dateFormatComponents[component].getPattern(this)),property:dateFormatComponents[component].property,start:pos,end:pos+=component.length
					})
				}
				else{
					components.push(escapeRegExp(component));
					mask.push({
						pattern:new RegExp(escapeRegExp(component)),character:component,start:pos,end:++pos
					})
				}
		...
		,_attachDatePickerEvents:function(){
			...
			if(this.isInput){
				this.$element.on({
					focus:$.proxy(this.show,this),change:$.proxy(this.change,this)
				});
				if(this.options.maskInput){
					this.$element.on({
					keydown:$.proxy(this.keydown,this),keypress:$.proxy(this.keypress,this)
					})
				}
	...
	$.fn.datetimepicker.defaults={
		maskInput:false,pickDate:true,pickTime:true,pick12HourFormat:false,pickSeconds:true,startDate:-Infinity,endDate:Infinity,collapse:true
	...
	TPGlobal.getTemplate=function(is12Hours,showSeconds){
		return'<div class="timepicker-picker">'+'<table class="table-condensed"'+(is12Hours?' data-hour-format="12"':"")+">"+"<tr>"+'<td><a href="#" class="clicktime" data-action="incrementHours"><i class="fa fa-angle-up"></i></a></td>'+'<td class="separator"></td>'+'<td><a href="#" class="clicktime" data-action="incrementMinutes"><i class="fa fa-angle-up"></i></a></td>'+(showSeconds?'<td class="separator"></td>'+'<td><a href="#" class="clicktime" data-action="incrementSeconds"><i class="fa fa-angle-up"></i></a></td>':"")+(is12Hours?'<td class="separator"></td>':"")+"</tr>"+"<tr>"+"<td>"+TPGlobal.hourTemplate+"</td> "+'<td class="separator">:</td>'+"<td>"+TPGlobal.minuteTemplate+"</td> "+(showSeconds?'<td class="separator">:</td>'+"<td>"+TPGlobal.secondTemplate+"</td>":"")+(is12Hours?'<td class="separator"></td>'+"<td>"+'<button type="button" class="btn btn-primary" data-action="togglePeriod"></button>'+"</td>":"")+"</tr>"+"<tr>"+'<td><a href="#" class="clicktime" data-action="decrementHours"><i class="fa fa-angle-down"></i></a></td>'+'<td class="separator"></td>'+'<td><a href="#" class="clicktime" data-action="decrementMinutes"><i class="fa fa-angle-down"></i></a></td>'+(showSeconds?'<td class="separator"></td>'+'<td><a href="#" class="clicktime" data-action="decrementSeconds"><i class="fa fa-angle-down"></i></a></td>':"")+(is12Hours?'<td class="separator"></td>':"")+"</tr>"+"</table>"+"</div>"+'<div class="timepicker-hours" data-action="selectHour">'+'<table class="table-condensed">'+"</table>"+"</div>"+'<div class="timepicker-minutes" data-action="selectMinute">'+'<table class="table-condensed">'+"</table>"+"</div>"+(showSeconds?'<div class="timepicker-seconds" data-action="selectSecond">'+'<table class="table-condensed">'+"</table>"+"</div>":"")
	}	
})(window.jQuery);
