			...
			if(
				...
				for (var key in p) {
					if (p.hasOwnProperty(key)) {
						...
						if(key == 'counter_device'){
							if(valTmp == 1){
								$('#counter_device_yes').attr('checked', valTmp);
							} else{
								$('#counter_device_no').attr('checked', valTmp);
							}
						}
						if(key == 'update_fmi_enable'){
							if(valTmp == 1){
								$('#update_fmi_enable_yes').attr('checked', valTmp);
							} else{
								$('#update_fmi_enable_no').attr('checked', valTmp);
							}
						}
					}
				}
