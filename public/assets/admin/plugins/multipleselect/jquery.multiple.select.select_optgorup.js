        ...
        optionToHtml: function (i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option')) {
                ...
                if ((this.options.blockSeparator > "") && (this.options.blockSeparator == $elm.val())) {
                    html.push(
                        '<li' + clss + style + '>',
                        '<label class="' + this.options.blockSeparator + (disabled ? 'disabled' : ' class="option"') + '">',
                        text,
                        '</label>',
                        '</li>'
                    );
                    ...
                    html.push(
                        '<li' + clss + style + '>',
                        '<label' + (disabled ? ' class="disabled"' : ' class="option"') + '>',
        ...
        filter: function () {
            ...
            if (text.length === 0) {
                ...
                this.$selectGroups.each(function () {
					...
					if($parent.text().toLowerCase().indexOf(text) > 0 && $items.filter('[data-group="' + group + '"]').length === 0){
						$parent['show']();
						var child = that.$selectItems.filter('.'+group);
						var pchild = child.parent();
						pchild['show']();
					}
                });
