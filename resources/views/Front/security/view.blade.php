@extends('Front.templates.tpl_default')
...
<div class="slider-area">
    <div class="slider-active swiper-container swiper-container-fade swiper-container-initialized swiper-container-horizontal">
        <div class="swiper-wrapper" id="swiper-wrapper-b319510c677d27363" aria-live="polite" style="transition-duration: 0ms;">
            <!-- Image slider -->
            @foreach ($datas['user'] as $user)
            <div class="swiper-slide swiper-slide-next swiper-slide-duplicate-prev" data-swiper-slide-index="1" role="group" aria-label="3 / 4" style="width: 1674px; opacity: 0; transform: translate3d(-3348px, 0px, 0px); transition-duration: 0ms;">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <div class="slider-content-1 slider-animated-1">
                                    ...
                                    <h1 class="animated">{{$user->name}}</h1>
            ...
            @endforeach
            <!-- Image slider -->
            <div class="home-slider-prev main-slider-nav" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-b319510c677d27363"><i class="fa fa-angle-left"></i></div>
            <div class="home-slider-next main-slider-nav" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-b319510c677d27363"><i class="fa fa-angle-right"></i></div>
            <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="6 / 4" style="width: 1674px; opacity: 0; transform: translate3d(-5022px, 0px, 0px); transition-duration: 0ms;">
                <div class="intro-section slider-height-1 slider-content-center bg-img single-animation-wrap slider-bg-color-1" style="background-image:url(assets/images/slider/slider-bg-1.jpg)">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6">
                                <div class="slider-content-1 slider-animated-1">
                                    <h3 class="animated">new arrival</h3>
                                    <h1 class="animated">Data from Controller</h1>
                                    <div class="slider-btn btn-hover">
                                        <a href="product-details.html" class="btn animated">
                                            Shop Now <i class=" ti-arrow-right "></i>
                                        </a>
...
<div class="banner-area pt-100 pb-70">
    <div class="container">
        <div class="row">
            <?php
                $arr_slides = json_decode($datas['slides'], true);
                $no_img = 0;
            foreach ($arr_slides as $item) {
                if ($item['display'] != 1) {
                    continue;
                }
            ?>
            <div class="col-lg-4 col-md-6 col-12">
                <div class="banner-wrap mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                    <a href="product-details.html"><img src="assets/images/banner/{{$item['name']}}" alt=""></a>
...
<div class="product-area pb-95">
    <div class="container">
        ...
        <div class="product-slider-active-1 swiper-container swiper-container-initialized swiper-container-horizontal">
            <div class="swiper-wrapper" id="swiper-wrapper-a811bd3214103e634" aria-live="polite" style="transform: translate3d(-1200px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="1 / 13" style="width: 270px; margin-right: 30px;">
                ...
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="2 / 13" style="width: 270px; margin-right: 30px;">
                ...
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="3 / 13" style="width: 270px; margin-right: 30px;">
                ...
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="4" role="group" aria-label="4 / 13" style="width: 270px; margin-right: 30px;">
                ...
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="11 / 13" style="width: 270px; margin-right: 30px;">
                    <div class="product-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                        <div class="product-img img-zoom mb-25">
                            <a href="product-details.html">
                                <img src="assets/images/product/product-2.png" alt="">
                ...
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="12 / 13" style="width: 270px; margin-right: 30px;">
                    <div class="product-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                        <div class="product-img img-zoom mb-25">
                            <a href="product-details.html">
                                <img src="assets/images/product/product-3.png" alt="">
                ...
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="13 / 13" style="width: 270px; margin-right: 30px;">
                    <div class="product-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
                        <div class="product-img img-zoom mb-25">
                            <a href="product-details.html">
                                <img src="assets/images/product/product-4.png" alt="">
            ...
            <div class="product-prev-1 product-nav-1 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-a811bd3214103e634"><i class="fa fa-angle-left"></i></div>
            <div class="product-next-1 product-nav-1 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-a811bd3214103e634"><i class="fa fa-angle-right"></i></div>
            <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-5 col-md-5">
                <div class="banner-wrap mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="banner-content-3">
                        <h3>Up To 30% <img src="assets/images/icon-img/sale.png" alt=""> Every Item</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
                <div class="service-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
                <div class="service-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                    <div class="service-img">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
                <div class="service-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                    <div class="service-img">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-30">
                <div class="service-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
                    <div class="service-img">
...
<div class="product-area pb-100">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="home-single-product-img aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                    <a href="product-details.html"><img src="assets/images/product/single-product.png" alt=""></a>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="home-single-product-content">
                    <h2 data-aos="fade-up" data-aos-delay="200" class="aos-init aos-animate">Modern Chair</h2>
                    <h3 data-aos="fade-up" data-aos-delay="400" class="aos-init aos-animate">$20.25</h3>
                    <p data-aos="fade-up" data-aos-delay="600" class="aos-init aos-animate">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempo incididunt ut labore et dolore mt aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate</p>
                    <div class="product-color aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
                        <span>Color :</span>
                        <ul>
                    ...
                    <div class="product-details-action-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="1000">
...
<div class="banner-area pb-95 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
    <div class="container">
...
<div class="product-area pb-60">
    <div class="container">
        <div class="section-title-tab-wrap mb-75">
            <div class="section-title-2 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                <h2>Hot Products</h2>
            </div>
            <div class="tab-style-1 nav aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
            ...
            <div id="pro-1" class="tab-pane active">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-wrap mb-35 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                            <div class="product-img img-zoom mb-25">
                                <a href="product-details.html">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-wrap mb-35 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                            <div class="product-img img-zoom mb-25">
                                <a href="product-details.html">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-wrap mb-35 aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                            <div class="product-img img-zoom mb-25">
                                <a href="product-details.html">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="product-wrap mb-35 aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
                            <div class="product-img img-zoom mb-25">
                                <a href="product-details.html">
                                    <img src="assets/images/product/product-4.png" alt="">
                                </a>
...
<div class="brand-logo-area pb-95">
    <div class="container">
        <div class="brand-logo-active swiper-container swiper-container-initialized swiper-container-horizontal">
            <div class="swiper-wrapper" id="swiper-wrapper-719cda6bc10819f88" aria-live="polite" style="transform: translate3d(-1168px, 0px, 0px); transition-duration: 0ms;">
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="1 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-2.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="2 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-3.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="3 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-4.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="4 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="1000">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-5.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="5" role="group" aria-label="5 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="1200">
                ...
                <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="6 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-1.png" alt=""></a>
                    </div>
                </div>
                ...
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="13 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-2.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="14 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-3.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="3" role="group" aria-label="15 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="800">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-4.png" alt=""></a>
                    </div>
                </div>
                <div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="4" role="group" aria-label="16 / 16" style="width: 213.6px; margin-right: 20px;">
                    <div class="single-brand-logo aos-init aos-animate" data-aos="fade-up" data-aos-delay="1000">
                        <a href="#"><img src="assets/images/brand-logo/brand-logo-5.png" alt=""></a>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrap mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrap mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                    <div class="blog-img-date-wrap mb-25">
                        <div class="blog-img">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-wrap mb-30 aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                    <div class="blog-img-date-wrap mb-25">
                        <div class="blog-img">
